...
namespace TrucoProject.Net.Events
{
    ...
    {
        // Dictionary: Event → list of callbacks
        private static readonly Dictionary<NetEvent.Type, List<Action<NetEvent>>> _listeners = new();
        ...
        public static void Emit(NetEvent netEvent) {
            ...
            if (!_listeners.ContainsKey(netEvent.EventType)) return;
